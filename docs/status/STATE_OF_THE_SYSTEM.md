...
| **`UNI/USD` long is a confirmed defect, not a hypothesis** (SCORECARD_REVIEW_2026-08-15) | n=1,096 — the largest single sample in the outcome table — hit-rate 6.3%, avg excess −7.1%, and it got *worse*, not better, as more days accumulated (was n=636, hit 12%, −2.4% at the 08-12 review). Every other finding in the scorecard reviews carries a "needs more regime diversity" caveat; this one does not. | A large, persistent, worsening miss on every long call the model makes for this symbol. Not yet capped or excluded. |
| **The investing book's drawdown is only half explained** (SCORECARD_REVIEW_2026-08-15) | JKS and INTC shorts are named, corroborated defects (advice-grading agrees with live position P&L: both n>250, 0.0 hit rate). But the book's two *largest* dollar losses are PDD and PRX.AS, both ordinary long theses with no corroborating explanation anywhere in this register. | −3.24% since the 08-05 reset, roughly half attributable, half not yet investigated. |
