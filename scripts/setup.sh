...
( cd engine && python3 -m ai_investing.backtest.main --optimize --save >/dev/null 2>&1 ) || say "(backtest seed skipped)"
( cd engine && python3 -m ai_investing.main --once --no-news >/dev/null 2>&1 ) || say "(cycle seed skipped)"
